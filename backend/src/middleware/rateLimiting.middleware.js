...
const LIMITS = {
  ...
  // НОВОЕ: Строгие лимиты для финансовых операций
  financial: {
    windowMs: 60 * 1000, // 1 минута
    max: 3, // максимум 3 финансовые операции в минуту
    message: 'Слишком много финансовых операций. Подождите минуту'
  },
  withdrawal: {
    windowMs: 10 * 60 * 1000, // 10 минут
    max: 2, // максимум 2 вывода в 10 минут
    message: 'Слишком частые запросы на вывод. Подождите 10 минут'
  },
  adminBalance: {
    windowMs: 60 * 1000, // 1 минута
    max: 5, // максимум 5 корректировок баланса в минуту
    message: 'Слишком много корректировок баланса'
  },
  general: {
    windowMs: 60 * 1000, // 1 минута  
